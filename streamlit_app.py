...
faq_data = {
    ...
    "How do I submit an expense report?": "Expense reports are to be completed within thirty (30) days of incurring the expense. Attach receipts for all expenses. Please itemize expenses separately and in order of date incurred. To simplify the completion of expense reports, consider the following guidelines: Please have the most up-to-date expense report saved on your one-drive. The completed expense report, along with supporting receipts should be e-mailed to accounting@plum.io. You can also hit the submit button in the expense report which opens an email automatically with the expense report attached for you to send. Please provide a detailed business purpose for all expenses so they can be coded appropriately. All expenses documented must be associated with a valid business purpose and fall within company guidelines Items paid for in non-local currency (US or Canadian dollars, based on your designated office) will be translated at the daily rate per oanda.com on the date of the transaction Questions and concerns regarding the completion of an expense report may be reviewed with the Finance department."
}
