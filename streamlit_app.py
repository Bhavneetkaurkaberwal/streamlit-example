...
faq_data = {
    ...
    "I'm a lonely 30-something with a dog and a cat who loves to paint. What are some of the social Slack channels I should consider joining?": "#pets, #crafting-crew, #random, #forcedfun"
}
